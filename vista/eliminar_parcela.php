    ...
    <div>
        ...
        <div class="bg-white container mt-5 border border-dark pb-3 card">
            <form action="../controlador/controlador_parcelas.php" method="post">
                ...
                <h2 class="text-center mt-3 lead" style="font-size: xx-large;" ><strong>Eliminar Parcela</strong></h2>
                <div class="d-flex">
                ...
                <div class="d-flex mt-4">
                    ...
                    <input type="text" class="form-control w-75" id="nombre" name="nombre" value="<?php echo $parcela['nombre'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="poligono"><strong>Poligono:</strong></label>
                    <input type="number" class="form-control w-75" id="poligono" name="poligono" value="<?php echo $parcela['poligono'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="recinto"><strong>Recinto:</strong></label>
                    <input type="number" class="form-control w-75" id="recinto" name="recinto" value="<?php echo $parcela['recinto'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="superficie"><strong>Superficie:</strong></label>
                    <input type="number" class="form-control w-75" id="superficie" name="superficie" value="<?php echo $parcela['superficie'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="cultivo"><strong>cultivo:</strong></label>
                    <input type="text" class="form-control w-75" id="cultivo" name="cultivo" value="<?php echo $parcela['cultivo'] ?>" readonly>
                </div>
