    ...
    <div>
        ...
        <div class="bg-white container mt-5 border border-dark pb-3 card">
            <form action="../controlador/controlador_maquinaria.php" method="post">
                ...
                <h2 class="text-center mt-3 lead" style="font-size: xx-large;"><strong>Eliminar Maquinaria</strong></h2>
                <div class="d-flex">
                    <label class="col-md-2 lead" for="id_maquinaria"><strong>ID:</strong></label>
                    <input name="id_maquinaria" class="form-control w-75" value="<?php echo $maquinaria['id_maquinaria'] ?>" readonly>
                </div>
                <div class="d-flex mt-4">
                    <label class="col-md-2 lead" for="vehiculo"><strong>Nombre:</strong></label>
                    <input type="text" class="form-control w-75" id="vehiculo" name="vehiculo" value="<?php echo $maquinaria['Vehículo'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="marca"><strong>Marca:</strong></label>
                    <input type="text" class="form-control w-75" id="marca" name="marca" value="<?php echo $maquinaria['Marca'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="modelo"><strong>Modelo:</strong></label>
                    <input type="number" class="form-control w-75" id="modelo" name="modelo" value="<?php echo $maquinaria['Modelo'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="consumo"><strong>Consumo:</strong></label>
                    <input type="number" class="form-control w-75" id="consumo" name="consumo" value="<?php echo $maquinaria['Consumo'] ?>" readonly>
                </div>
