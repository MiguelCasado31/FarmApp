        ...
        <div class="bg-white container mt-5 border border-dark pb-3 card">
            <form action="../controlador/controlador_actividades.php" method="post">
                ...
                <div class="d-flex mt-4">
                    ...
                    <input type="text" class="form-control w-75" id="trabajo" name="trabajo" value="<?php echo $actividad['trabajo'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="fecha"><strong>Fecha:</strong></label>
                    <input type="date" class="form-control w-75" id="fecha" name="fecha" value="<?php echo $actividad['fecha'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                ...
                <div class="d-flex mt-3">
                    ...
                    <input type="time" class="form-control w-75" id="duracion" name="duracion" value="<?php echo $actividad['duracion'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="maquinaria"><strong>Maquinaria:</strong></label>
                    <input type="text" class="form-control w-75" id="maquinaria" name="maquinaria" value="<?php echo $actividad['Vehículo'] ?>" readonly>
                </div>
                <div class="d-flex mt-3">
                    <label class="col-md-2 lead" for="comentarios"><strong>Comentarios:</strong></label>
                    <input type="text" class="form-control w-75" id="comentarios" name="comentarios" value="<?php echo $actividad['comentarios'] ?>" readonly>
                </div>
